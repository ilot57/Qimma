-- =====================================================
-- QIMMA AI EXAM CORRECTION PLATFORM
-- Supabase Database Schema with Clerk Integration
-- =====================================================
...
-- System can insert credit transactions (via service role)
-- This will be handled by API routes with elevated permissions
...
-- Run this manually with your Clerk user ID
-- =====================================================

-- INSERT INTO users (clerk_user_id, email, first_name, last_name, role, subscription_tier)
-- VALUES ('your_clerk_user_id_here', 'admin@yourdomain.com', 'Admin', 'User', 'super_admin', 'full')
